...
for patient in patients:
    if machine1.next_available_slot[patient.call_date + 1] < machine2.next_available_slot[patient.call_date + 1]:
        if patient.category == 1:
            schedule_appointment(machine1, patient, slot_duration_t1)
        else:
            schedule_appointment(machine1, patient, slot_duration_t2)
    else:
        if patient.category == 1:
            schedule_appointment(machine2, patient, slot_duration_t1)
        else:
